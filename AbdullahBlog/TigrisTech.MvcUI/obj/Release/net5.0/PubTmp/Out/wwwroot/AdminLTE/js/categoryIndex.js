                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = dataTable.row.add([
                            ...
                            convertToShortDate(categoryAddAjaxModel.CategoryDto.Category.CreateDate),
                            categoryAddAjaxModel.CategoryDto.Category.CreateByName,
            ...
            $.post(actionUrl, dataToSend).done(function(data) {
                ...
                if (isValid) {
                    ...
                    dataTable.row(tableRow).data([
                        ...
                        convertToShortDate(categoryUpdateAjaxModel.CategoryDto.Category.CreateDate),
                        categoryUpdateAjaxModel.CategoryDto.Category.CreateByName,
