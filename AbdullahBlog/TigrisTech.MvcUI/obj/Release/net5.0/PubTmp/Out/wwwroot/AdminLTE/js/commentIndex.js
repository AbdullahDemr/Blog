                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).data([
                                ...
                                commentUpdateAjaxModel.CommentDto.Comment.CreateByName,
                        ...
                        success: function (data) {
                            ...
                            if (commentResult.Data) {
                                dataTable.row(tableRow).data([
                                    ...
                                    `${convertToShortDate(commentResult.Data.Comment.CreateDate)}`,
                                    commentResult.Data.Comment.CreateByName,
